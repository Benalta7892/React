export default function Container() {
  function handleClick(e) {
    console.log("Click from handleClick !");
  }

  function handleClickWithId(id) {
    console.log("Click from handleClickWithId !", id);
  }

  function handleClickWithIdAndEventObject(e, id) {
    console.log("Click from handleClickWithIdAndEventObject !", e, id);
  }

  return (
    <div>
      <h1>Utiliser des évènements</h1>
      {/* On peut ajouter un évènement directement dans le JSX avec une fonction anonyme,
      mais ce n'est pas pratique s'il y a beaucoup de code */}
      <button onClick={() => console.log("Click !")}>Click</button>

      {/* Mauvaise pratique, peu maintenable */}
      <button
        onClick={() => {
          console.log("Click, Mauvaise pratique !");
          console.log("Click, Mauvaise pratique !");
          console.log("Click, Mauvaise pratique !");
        }}>
        Click
