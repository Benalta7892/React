...
/*
    ...
    La callback est TOUJOURS appelée avec TOUS les arguments qui
...
/*
    ...
    Définition: Permet de retourner un nouveau tableau contenant les résultats
    du retour d'une fonction callback appelée sur chaque élément d'un tableau.
...
/*
    ...
    Valeur de retour : Un tableau contenant les éléments ayant passés le
    test du retour de la fonction callback.
...
numbers2.sort((a, b) => b - a); // tri croissant a pour ordre croissant et b pour ordre décroissant
